...
type AliyunOss struct {
	...
	ReplaceOriginalHost string `mapstructure:"replace-original-host" yaml:"replace_original_host" json:"replace_original_host"`       // 替换的原始主机
	ReplaceLaterHost    string `mapstructure:"replace-later-host" yaml:"replace_later_host"   json:"replace_later_host"`              // 替换后的主机
