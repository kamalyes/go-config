...
type AliyunOss struct {
	...
	ReplaceOriginalHost string `mapstructure:"replace_original_host" yaml:"replace-original-host" json:"replace_original_host"` // 替换的原始主机
	ReplaceLaterHost    string `mapstructure:"replace_later_host" yaml:"replace-later-host" json:"replace_later_host"`          // 替换后的主机
