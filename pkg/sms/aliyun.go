...
type AliyunSms struct {
	SecretID             string `mapstructure:"secret-id" yaml:"secret-id" json:"secretId"             validate:"required"`                           // 阿里云短信服务的 Secret ID
	SecretKey            string `mapstructure:"secret-key" yaml:"secret-key" json:"secretKey"            validate:"required"`                         // 阿里云短信服务的 Secret Key
	Sign                 string `mapstructure:"sign" yaml:"sign" json:"sign"                  validate:"required"`                                    // 短信签名
	ResourceOwnerAccount string `mapstructure:"resource-owner-account" yaml:"resource-owner-account" json:"resourceOwnerAccount" validate:"required"` // 资源所有者账户
	ResourceOwnerID      int64  `mapstructure:"resource-owner-id" yaml:"resource-owner-id" json:"resourceOwnerId"     validate:"required"`            // 资源所有者 ID
	TemplateCodeVerify   string `mapstructure:"template-code-verify" yaml:"template-code-verify" json:"templateCodeVerify"   validate:"required"`     // 短信模板代码
