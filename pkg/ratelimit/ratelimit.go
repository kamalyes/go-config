...
type RateLimit struct {
	...
	GlobalLimit       *LimitRule    `mapstructure:"global_limit" yaml:"global-limit" json:"global_limit"`                      // 全局限流规则
	Routes            []RouteLimit  `mapstructure:"routes" yaml:"routes" json:"routes"`                                        // 路由级别限流
	IPRules           []IPRule      `mapstructure:"ip_rules" yaml:"ip-rules" json:"ip_rules"`                                  // IP规则
	UserRules         []UserRule    `mapstructure:"user_rules" yaml:"user-rules" json:"user_rules"`                            // 用户规则
