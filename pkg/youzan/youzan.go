...
type YouZan struct {
	...
	ClientID      string `mapstructure:"client_id" yaml:"client-id" json:"client_id"             validate:"required"`           // 客户端 ID
	ClientSecret  string `mapstructure:"client_secret" yaml:"client-secret" json:"client_secret"         validate:"required"`   // 客户端密钥
	AuthorizeType string `mapstructure:"authorize_type" yaml:"authorize-type" json:"authorize_type"        validate:"required"` // 授权类型
	GrantID       string `mapstructure:"grant_id" yaml:"grant-id" json:"grant_id"              validate:"required"`             // 授权 ID
