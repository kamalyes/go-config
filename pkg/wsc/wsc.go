...
type WSC struct {
	...
	ReadTimeout          time.Duration `mapstructure:"read_timeout" yaml:"read-timeout" json:"read_timeout"`                               // 读取超时(秒)
	WriteTimeout         time.Duration `mapstructure:"write_timeout" yaml:"write-timeout" json:"write_timeout"`                            // 写入超时(秒)
	IdleTimeout          time.Duration `mapstructure:"idle_timeout" yaml:"idle-timeout" json:"idle_timeout"`                               // 空闲超时(秒)
