...
func (sg *SmartConfigGenerator) registerAllModules() {
	modules := []ModuleConfig{
		...
		{Name: "clickhouse", PackageName: "database", DefaultFunc: func() interface{} { return database.DefaultClickHouse() }, OutputSubDir: "database", Description: "ClickHouse列式分析型数据库", Enabled: true},
		{Name: "cockroachdb", PackageName: "database", DefaultFunc: func() interface{} { return database.DefaultCockroachDB() }, OutputSubDir: "database", Description: "CockroachDB分布式SQL数据库", Enabled: true},
